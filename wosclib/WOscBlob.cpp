...
{
	// get blob size
	m_dataLen = WOscUtil::BufferTo<int>(binaryData);
...
WOscBlob::WOscBlob(const char* binaryData, int dataLen)
{
	...
	WOscUtil::FillBufferWith(m_buffer, dataLen);
 ...
 */
void
WOscBlob::GetBuffer(char* buffer, int bufferLen) const
{

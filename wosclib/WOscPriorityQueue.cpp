 ...
 */
void
WOscPriorityQueue::InsertItem(WOscQueueItem *item)
{
 ...
 */
void
WOscPriorityQueue::RemoveItem(int idx)
{
 ...
 */
WOscQueueItem*
WOscPriorityQueue::RemoveEarliestItem()
{
	...
	if ( m_itemsInList == 0 )
		throw WOscException(ERR_REMOVE_FROM_EMPTY_QUEUE, __FILE__, __LINE__);
